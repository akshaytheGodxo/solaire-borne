...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: "Every asset on our platform is verified by our team to ensure our highlight quality standards. Not happy? We offer a 30-day refund guarantee.",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
  ...
  return (
    <>
      <MaxWidthWrapper>
        ...
        <ProductReel query={{sort: "desc", limit: 4}} title="Brand New" href="Something"/>
      </MaxWidthWrapper>
