...
const ThankYou = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden md:block h-80 lg:absolute overflow-hidden  lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        <Image
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2 ">
            ...
            <div className="mt-16 text-sm font-medium">
                  ...
                  return (
                    ...
                    >
                      <div className="relative h-24 w-24">
                        {typeof images !== "string" && images.url ? (
                          <Image
                            fill
                            src={images.url}
              ...
              <div className="space-y-6 border-gray-200 border- border-t pt-6 text-sm font-medium">
